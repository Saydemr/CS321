...
////template < template<typename> typename Container, IsCourse T>
//////template <AnyContainer T>
////auto print(const Container<T>& container, auto title)
//////requires IsCourse<T>
////{
...
//template <typename T>
//auto print(const T& v, auto title)
//{
//    std::cout << title << std::endl;
...
//auto my_sort(T& container, Lambda lambda)
//{
...
////    // < and > operators that does alphabetical comparison are already overloaded for std::string in the stdlibrary
//    my_sort(l, ascending_by_name);
//    print(l, "list<Course> ascending sorted by name");

//////    // Q1c (5 pts) - print works on list<T>
//////    // Q3d (5 pts) - my_sort returns correctly for print to work (no extra copies of the container shall bemade)
