...
auto print(auto v, auto title)                                                -> void
{
...
auto print(const Container<T>& container, auto header)                        -> void
requires(IsCourse<T>)
{
...
auto ascending_by_name = [](Course a, Course b) { return a.name < b.name; };
auto descending_by_code = [](Course a, Course b){ return a.code > b.code; };
...
int main(int argc, char* argv[])
{
    ...
    auto d = my_sort(l, ascending_by_name);
    ...
    auto e = my_sort(l, descending_by_code);
    return 0;
}
